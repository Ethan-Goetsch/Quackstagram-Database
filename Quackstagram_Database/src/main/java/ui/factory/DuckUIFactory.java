...
public class DuckUIFactory extends UIFactory
{
    private static final int WIDTH = 300;
    private static final int HEIGHT = 500;
    private static final int NAV_ICON_SIZE = 50; // Corrected static size for bottom icons
    private static final int IMAGE_WIDTH = WIDTH - 100; // Width for the image posts
    private static final int IMAGE_HEIGHT = 150; // Height for the image posts
    private static final Color LIKE_BUTTON_COLOR = new Color(90, 247, 255); // Color for the like button
    ...
    public JPanel createNavigationPanel(IAction<UINavigationType> action)
    {
        ...
        navigationPanel.add(createIconButton(PathFile.DuckIcon1, UINavigationType.HOME, action));
        navigationPanel.add(Box.createHorizontalGlue());
        navigationPanel.add(createIconButton(PathFile.DuckIcon2, UINavigationType.EXPLORE, action));
        navigationPanel.add(Box.createHorizontalGlue());
        navigationPanel.add(createIconButton(PathFile.DuckIcon3, UINavigationType.UPLOAD, action));
        navigationPanel.add(Box.createHorizontalGlue());
        navigationPanel.add(createIconButton(PathFile.DuckIcon4, UINavigationType.NOTIFICATION, action));
        navigationPanel.add(Box.createHorizontalGlue());
        navigationPanel.add(createIconButton(PathFile.DuckIcon5, UINavigationType.PROFILE, action));
